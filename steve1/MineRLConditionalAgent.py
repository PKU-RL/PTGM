# steve-1 agent: use target image embedding as the goal. add the goal to VPT's image embedding.
import numpy as np
import torch as th
import inspect
from gym3.types import DictType

from VPT.agent import MineRLAgent, resize_image, AGENT_RESOLUTION, \
