...
import steve1.utils.video_utils
...
class EpisodeStorage:
    ...
    def load_frames(self, only_range=None, to_rgb=True):
        ...
        try:
            frames = steve1.utils.video_utils.load_video_to_lst(self.frames_dirpath, 
                to_rgb=to_rgb, only_range=only_range, length=len(self))
        except Exception as e:
            print('Fail to load video frames:', e)
            print('Path:', self.frames_dirpath, 'Range:', only_range)
            sys.exit(0)
        return frames
