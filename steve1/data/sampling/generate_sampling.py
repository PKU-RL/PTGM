...
from steve1.data.minecraft_dataset import get_valid_episodes

DATASET_DIRS = {
    'contractor': 'downloads/dataset_contractor',
}
...
def generate_train_val_split(episodes, args):
    ...
    print(total_len, len(episodes), train_frames, val_frames)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='seed1')
    parser.add_argument('--output_dir', type=str, default='/downloads/samplings')
