...
class VPTPPO(RecurrentPPO):
    def __init__(self, *args, kl_coef=.2, kl_decay=.9995, use_task_ids=False, n_tasks=1, log_dir=None, finetune_full=False, **kwargs):
        ...
        self.finetune_full = finetune_full
    ...
    def collect_rollouts(
        ...
        save_rgb = True if self.num_timesteps % 50000 == 0 else False
        rgb_list = []
        ...
        if save_rgb:
            imageio.mimsave(os.path.join(self.log_dir, 'iter_step{}.gif'.format(self.num_timesteps)), rgb_list, duration=0.034)
